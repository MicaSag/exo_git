...
Descriptif du porjet :
_______________________
Il s'agit d'une simple page HTML qui permet l'affichage de la date et l'heure 
de la machine sur laquelle on se trouve.

Pour cela, un fichier javascript externe est appelé (dateheure.js) dans une page Html (AffichageDateHeure.html).

C'est ce script java qui permet de récupérer la date et l'heure de la machine.

Ensuite, le navigateur se charge de traduire le code de la page Html (AffichageDateHeure.html) 
et permet l'affichage de la date et de l'heure de la machine.